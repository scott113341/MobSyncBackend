...
User.create(username: 'user1', name: 'User Oneguru', device_id: 'abc')
User.create(username: 'user2', name: 'User Twomaster', device_id: 'abc')
User.create(username: 'user3', name: 'User Threedude', device_id: 'abc')
User.create(username: 'user4', name: 'User Fourman', device_id: 'abc')
User.create(username: 'user5', name: 'User Fivemonster', device_id: 'abc')
